...
# We need to inject the "One Unified Growth Engine" section back into index.html
# It should go right after the </section> of `fv-logo-cloud-modern`
     ...
     <section class="py-5" style="background-color: #ffffff; position: relative; overflow: hidden;">
        ...
        <div class="container py-5" style="position: relative; z-index: 1; max-width: 1200px;">
           ...
           <div class="mb-5 d-flex flex-column align-items-start" style="gap: 16px;">
              <div style="display: inline-flex; align-items: center; border-radius: 9999px; background-color: #000000; color: #ffffff; padding: 4px 12px; font-size: 12px; font-weight: 600; font-family: 'Rubik', sans-serif;">
                 Platform
              </div>
              <div class="d-flex flex-column" style="gap: 8px;">
                 <h2 style="font-family:'Rubik', sans-serif; font-size: 48px; font-weight: 400; color: #000000; letter-spacing: -2px; margin: 0; line-height: 1.1;">
           ...
           <style>
               ...
               .shadcn-icon { font-size: 28px; color: #000000; margin-bottom: 20px; font-weight: 300; }
               .shadcn-title { font-family: 'Rubik', sans-serif; font-size: 20px; font-weight: 400; color: #000000; margin-bottom: 8px; letter-spacing: -0.5px; }
...
# Inject immediately after the fv-logo-cloud-modern closing section
match = re.search(r'<!-- LOGO CLOUD \(MODERN GRID\).*?</section>', content, flags=re.DOTALL)
if match:
    # insert after
    end_idx = match.end()
    content = content[:end_idx] + "\n" + new_bento + content[end_idx:]
    with open(file_path, 'w', encoding='utf-8') as f:
        f.write(content)
    print("Injected One Unified Growth Engine successfully.")
else:
    print("Could not find logo cloud section.")
