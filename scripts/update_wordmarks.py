...
new_grid = '''
              <div class="logo-grid">
                 ...
                 <div class="logo-grid-item bg-light border-right relative-box">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/f/fa/HubSpot_Logo.svg" alt="HubSpot">
                 </div>
                 <div class="logo-grid-item bg-white border-right relative-box">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/b/ba/Stripe_Logo%2C_revised_2016.svg" alt="Stripe">
                 </div>
                 <div class="logo-grid-item bg-light">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/5/5e/Vercel_logo_black.svg" alt="Vercel">
                 </div>
              </div>
'''
...
if match:
    ...
    with open('c:/Users/my/Desktop/chatgpt/index.html', 'w', encoding='utf-8') as f:
        f.write(new_html)
    print("Injected Wikipedia Wordmark SVGs without redundant text labels.")
else:
    print("Regex failed.")
