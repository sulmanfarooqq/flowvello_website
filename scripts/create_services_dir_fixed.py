...
# Remove the hero content and inject our new hero
...
# Correctly target '<!-- FAQ CONTENT -->'
content = re.sub(r'(?s)<!-- FAQ CONTENT -->.*?<!-- CLOSING CTA \(SPLIT\) -->', '''
...
print("Services directory completely rebuilt and fixed.")
