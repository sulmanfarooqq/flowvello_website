...
new_content = f"""
   ...
   <section class="fv-page-hero" style="background:#111827; padding:160px 0 100px; position:relative; overflow:hidden;">
      <!-- Subtle grid background matching premium vibe -->
      ...
      <div class="container">
         ...
         <div class="row">
            <div class="col-md-6 col-lg-4 mb-4 wow fadeInUp" data-wow-delay="0.1s">
               <div style="padding:40px; background:#f9fafb; border-radius:8px; height:100%; transition:0.3s;" class="hover-shadow">
...
# Modify the CTA text within new_content to be specific to the About page CTA instruction
