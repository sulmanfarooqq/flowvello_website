...
new_content = f"""
      ...
      <div class="container">
         <div class="row align-items-center">
            <div class="col-lg-6 pr-lg-5 mb-5 mb-lg-0 wow fadeInLeft" data-wow-delay="0.1s">
               <span class="d-inline-block mb-3" style="color:var(--fv-red); font-family:'Rubik',sans-serif; font-size:13px; font-weight:700; letter-spacing:2px; text-transform:uppercase;">OUR MISSION</span>
               <h2 style="font-family:'Rubik',sans-serif; font-size:46px; font-weight:600; letter-spacing:-1.5px; color:#111827; margin-bottom:30px; line-height:1.15;">We don't automate for the sake of automation.</h2>
               <p style="font-family:'Rubik',sans-serif; font-size:18px; line-height:1.7; color:#6f7075; margin-bottom:20px;">We first understand how a business actually works.</p>
               <p style="font-family:'Rubik',sans-serif; font-size:18px; line-height:1.7; color:#6f7075; margin-bottom:20px;">Then we identify where time, money and productivity are being lost.</p>
            ...
            <div class="col-lg-6 wow fadeInRight" data-wow-delay="0.2s">
               <div style="position:relative; border-radius:12px; overflow:hidden; box-shadow:0 25px 50px -12px rgba(0,0,0,0.15);">
                  <img src="img/case-study-1.webp" alt="Business Operations" style="width:100%; display:block; filter: grayscale(20%);">
      ...
      <div class="container">
         <div class="row mb-5 pb-3">
            <div class="col-lg-8 wow fadeInUp" data-wow-delay="0.1s">
               <span class="d-inline-block mb-2" style="color:var(--fv-red); font-family:'Rubik',sans-serif; font-size:13px; font-weight:700; letter-spacing:2px; text-transform:uppercase;">THE PROBLEM</span>
               <h2 style="font-family:'Rubik',sans-serif; font-size:46px; font-weight:600; letter-spacing:-1.5px; color:#111827; line-height: 1.15;">You might need Flow Vello if...</h2>
            </div>
         </div>
         <div class="row">
            <div class="col-md-6 col-lg-4 mb-4 wow fadeInUp" data-wow-delay="0.1s">
               <div style="background:#ffffff; padding:40px 30px; border-radius:12px; box-shadow:0 4px 6px -1px rgba(0,0,0,0.05); height:100%; border-top:3px solid var(--fv-red);">
                  ...
                  <p style="font-family:'Rubik',sans-serif; font-size:16px; color:#6f7075; line-height:1.7; margin:0;">Your team repeatedly copies data between systems.</p>
               </div>
            </div>
            <div class="col-md-6 col-lg-4 mb-4 wow fadeInUp" data-wow-delay="0.2s">
               <div style="background:#ffffff; padding:40px 30px; border-radius:12px; box-shadow:0 4px 6px -1px rgba(0,0,0,0.05); height:100%; border-top:3px solid var(--fv-red);">
                  ...
                  <p style="font-family:'Rubik',sans-serif; font-size:16px; color:#6f7075; line-height:1.7; margin:0;">Your software systems don't communicate with each other.</p>
               </div>
            </div>
            <div class="col-md-6 col-lg-4 mb-4 wow fadeInUp" data-wow-delay="0.3s">
               <div style="background:#ffffff; padding:40px 30px; border-radius:12px; box-shadow:0 4px 6px -1px rgba(0,0,0,0.05); height:100%; border-top:3px solid var(--fv-red);">
                  ...
                  <p style="font-family:'Rubik',sans-serif; font-size:16px; color:#6f7075; line-height:1.7; margin:0;">Leads are lost because follow-ups are entirely manual.</p>
               </div>
            </div>
            <div class="col-md-6 col-lg-4 mb-4 wow fadeInUp" data-wow-delay="0.4s">
               <div style="background:#ffffff; padding:40px 30px; border-radius:12px; box-shadow:0 4px 6px -1px rgba(0,0,0,0.05); height:100%; border-top:3px solid var(--fv-red);">
                  ...
                  <p style="font-family:'Rubik',sans-serif; font-size:16px; color:#6f7075; line-height:1.7; margin:0;">Employees answer the exact same customer questions every day.</p>
               </div>
            </div>
            <div class="col-md-6 col-lg-4 mb-4 wow fadeInUp" data-wow-delay="0.5s">
               <div style="background:#ffffff; padding:40px 30px; border-radius:12px; box-shadow:0 4px 6px -1px rgba(0,0,0,0.05); height:100%; border-top:3px solid var(--fv-red);">
                  ...
                  <p style="font-family:'Rubik',sans-serif; font-size:16px; color:#6f7075; line-height:1.7; margin:0;">Your business depends heavily on fragile, manual spreadsheets.</p>
               </div>
            </div>
            <div class="col-md-6 col-lg-4 mb-4 wow fadeInUp" data-wow-delay="0.6s">
               <div style="background:#ffffff; padding:40px 30px; border-radius:12px; box-shadow:0 4px 6px -1px rgba(0,0,0,0.05); height:100%; border-top:3px solid var(--fv-red);">
                  ...
                  <p style="font-family:'Rubik',sans-serif; font-size:16px; color:#6f7075; line-height:1.7; margin:0;">Management lacks a clear, real-time operational dashboard.</p>
               </div>
            </div>
         </div>
         ...
         <div class="row mt-5 pt-3 wow fadeInUp" data-wow-delay="0.7s">
            <div class="col-12 text-center">
               ...
               <h3 style="color:#111827; font-family:'Rubik',sans-serif; font-size:36px; margin:0; font-weight:600; letter-spacing:-1px;">We turn operational problems into systems that work automatically.</h3>
            </div>
         </div>
      </div>
   </section>
   ...
   <section style="padding:120px 0; background:#ffffff;">
      <div class="container">
         <div class="text-center mb-5 pb-4 wow fadeInUp" data-wow-delay="0.1s">
            <span class="d-inline-block mb-2" style="color:var(--fv-red); font-family:'Rubik',sans-serif; font-size:13px; font-weight:700; letter-spacing:2px; text-transform:uppercase;">WHY FLOW VELLO</span>
            <h2 style="color:#111827; font-family:'Rubik',sans-serif; font-size:46px; font-weight:600; letter-spacing:-1.5px; line-height:1.15;">Principles that drive results<span style="color:var(--fv-red);">.</span></h2>
         </div>
         <div class="row">
            <div class="col-md-6 col-lg-4 mb-5 wow fadeInUp" data-wow-delay="0.1s">
               <div style="padding-right:20px;">
                  <h4 style="margin:0 0 15px; font-size:22px; font-family:'Rubik',sans-serif; font-weight:600; color:#111827;">Start With the Problem</h4>
                  <p style="margin:0; color:#6f7075; line-height:1.7; font-size:16px; font-family:'Rubik',sans-serif;">We understand the business before recommending technology.</p>
               </div>
            </div>
            <div class="col-md-6 col-lg-4 mb-5 wow fadeInUp" data-wow-delay="0.2s">
               <div style="padding-right:20px;">
                  <h4 style="margin:0 0 15px; font-size:22px; font-family:'Rubik',sans-serif; font-weight:600; color:#111827;">Build Around Your Business</h4>
                  <p style="margin:0; color:#6f7075; line-height:1.7; font-size:16px; font-family:'Rubik',sans-serif;">Your workflows determine the system - not a template.</p>
               </div>
            </div>
            <div class="col-md-6 col-lg-4 mb-5 wow fadeInUp" data-wow-delay="0.3s">
               <div style="padding-right:20px;">
                  <h4 style="margin:0 0 15px; font-size:22px; font-family:'Rubik',sans-serif; font-weight:600; color:#111827;">Connect What You Already Use</h4>
                  <p style="margin:0; color:#6f7075; line-height:1.7; font-size:16px; font-family:'Rubik',sans-serif;">CRM, WhatsApp, email, databases, APIs and internal tools can work together.</p>
               </div>
            </div>
            <div class="col-md-6 col-lg-4 mb-5 wow fadeInUp" data-wow-delay="0.4s">
               <div style="padding-right:20px;">
                  <h4 style="margin:0 0 15px; font-size:22px; font-family:'Rubik',sans-serif; font-weight:600; color:#111827;">Automate the Work</h4>
                  <p style="margin:0; color:#6f7075; line-height:1.7; font-size:16px; font-family:'Rubik',sans-serif;">AI and software handle repetitive tasks so your team can focus on higher-value work.</p>
               </div>
            </div>
            <div class="col-md-6 col-lg-4 mb-5 wow fadeInUp" data-wow-delay="0.5s">
               <div style="padding-right:20px;">
                  <h4 style="margin:0 0 15px; font-size:22px; font-family:'Rubik',sans-serif; font-weight:600; color:#111827;">Engineer for Scale</h4>
                  <p style="margin:0; color:#6f7075; line-height:1.7; font-size:16px; font-family:'Rubik',sans-serif;">Systems are designed to evolve as the business grows.</p>
               </div>
            </div>
            <div class="col-md-6 col-lg-4 mb-5 wow fadeInUp" data-wow-delay="0.6s">
               <div style="padding-right:20px;">
                  <h4 style="margin:0 0 15px; font-size:22px; font-family:'Rubik',sans-serif; font-weight:600; color:#111827;">Stay After Launch</h4>
                  <p style="margin:0; color:#6f7075; line-height:1.7; font-size:16px; font-family:'Rubik',sans-serif;">We continue improving the system after deployment.</p>
               </div>
            </div>
         </div>
      </div>
   ...
   <section style="padding:120px 0; background:#111827; position:relative; overflow:hidden;">
      ...
      <div class="container" style="position:relative; z-index:1;">
         <div class="row align-items-center">
            <div class="col-lg-6 pr-lg-5 mb-5 mb-lg-0 wow fadeInLeft" data-wow-delay="0.1s">
               <span class="d-inline-block mb-3" style="color:var(--fv-red); font-family:'Rubik',sans-serif; font-size:13px; font-weight:700; letter-spacing:2px; text-transform:uppercase;">ENGINEERING</span>
               <h2 style="font-family:'Rubik',sans-serif; font-size:46px; font-weight:600; letter-spacing:-1.5px; color:#ffffff; margin-bottom:30px; line-height:1.15;">Business problems deserve engineered solutions.</h2>
               <p style="font-family:'Rubik',sans-serif; font-size:18px; line-height:1.7; color:#bdbec2; margin-bottom:0;">
   ...
   <section style="padding:120px 0; background:#f9fafb;">
      <div class="container">
         <div class="row mb-5 pb-3">
            <div class="col-lg-8 wow fadeInUp" data-wow-delay="0.1s">
               <span class="d-inline-block mb-2" style="color:var(--fv-red); font-family:'Rubik',sans-serif; font-size:13px; font-weight:700; letter-spacing:2px; text-transform:uppercase;">TARGET AUDIENCE</span>
               <h2 style="font-family:'Rubik',sans-serif; font-size:46px; font-weight:600; letter-spacing:-1.5px; line-height:1.15; color:#111827;">Who We Help</h2>
            </div>
         </div>
         <div class="row">
            <div class="col-md-4 mb-4 wow fadeInUp" data-wow-delay="0.1s">
               <div style="position:relative; height:300px; border-radius:12px; overflow:hidden; display:flex; align-items:flex-end; padding:30px;">
                  <img src="img/case-study-2.webp" style="position:absolute; inset:0; width:100%; height:100%; object-fit:cover; z-index:0; filter:brightness(0.5);">
            ...
            <div class="col-md-4 mb-4 wow fadeInUp" data-wow-delay="0.2s">
               <div style="position:relative; height:300px; border-radius:12px; overflow:hidden; display:flex; align-items:flex-end; padding:30px;">
                  <img src="img/case-study-3.webp" style="position:absolute; inset:0; width:100%; height:100%; object-fit:cover; z-index:0; filter:brightness(0.5);">
            ...
            <div class="col-md-4 mb-4 wow fadeInUp" data-wow-delay="0.3s">
               <div style="position:relative; height:300px; border-radius:12px; overflow:hidden; display:flex; align-items:flex-end; padding:30px;">
                  <img src="img/case-study-1.webp" style="position:absolute; inset:0; width:100%; height:100%; object-fit:cover; z-index:0; filter:brightness(0.5);">
            ...
            <div class="col-md-6 mb-4 wow fadeInUp" data-wow-delay="0.4s">
               <div style="position:relative; height:300px; border-radius:12px; overflow:hidden; display:flex; align-items:flex-end; padding:30px;">
                  <div style="position:absolute; inset:0; background:var(--fv-dark); z-index:0;"></div>
            ...
            <div class="col-md-6 mb-4 wow fadeInUp" data-wow-delay="0.5s">
               <div style="position:relative; height:300px; border-radius:12px; overflow:hidden; display:flex; align-items:flex-end; padding:30px;">
                  <div style="position:absolute; inset:0; background:var(--fv-red); z-index:0;"></div>
   ...
   <section style="padding:120px 0; background:#ffffff;">
      <div class="container">
         <div class="row mb-5 pb-3">
            <div class="col-lg-8 wow fadeInUp" data-wow-delay="0.1s">
               <span class="d-inline-block mb-2" style="color:var(--fv-red); font-family:'Rubik',sans-serif; font-size:13px; font-weight:700; letter-spacing:2px; text-transform:uppercase;">PHILOSOPHY</span>
               <h2 style="font-family:'Rubik',sans-serif; font-size:46px; font-weight:600; letter-spacing:-1.5px; line-height:1.15; color:#111827;">Core Values</h2>
            </div>
         </div>
         <div class="row">
            <div class="col-lg-6 mb-4 wow fadeInUp" data-wow-delay="0.1s">
               <div style="padding:50px; background:#f9fafb; border-radius:12px; height:100%; display:flex; flex-direction:column; justify-content:center;">
                  <h3 style="color:#111827; font-family:'Rubik',sans-serif; font-size:28px; font-weight:600; margin-bottom:20px; letter-spacing:-0.5px;">Understand Before We Build</h3>
                  <p style="color:#6f7075; font-family:'Rubik',sans-serif; font-size:16px; line-height:1.7; margin:0;">We don't automate a process we haven't completely understood.</p>
               </div>
            </div>
            <div class="col-lg-6 mb-4 wow fadeInUp" data-wow-delay="0.2s">
               <div style="padding:50px; background:#f9fafb; border-radius:12px; height:100%; display:flex; flex-direction:column; justify-content:center;">
                  <h3 style="color:#111827; font-family:'Rubik',sans-serif; font-size:28px; font-weight:600; margin-bottom:20px; letter-spacing:-0.5px;">Useful Over Impressive</h3>
                  <p style="color:#6f7075; font-family:'Rubik',sans-serif; font-size:16px; line-height:1.7; margin:0;">Technology only matters when it solves a real business problem.</p>
               </div>
            </div>
            <div class="col-lg-6 mb-4 wow fadeInUp" data-wow-delay="0.3s">
               <div style="padding:50px; background:#f9fafb; border-radius:12px; height:100%; display:flex; flex-direction:column; justify-content:center;">
                  <h3 style="color:#111827; font-family:'Rubik',sans-serif; font-size:28px; font-weight:600; margin-bottom:20px; letter-spacing:-0.5px;">Simple Beats Complicated</h3>
                  <p style="color:#6f7075; font-family:'Rubik',sans-serif; font-size:16px; line-height:1.7; margin:0;">The best system is one the team can actually use without friction.</p>
               </div>
            </div>
            <div class="col-lg-6 mb-4 wow fadeInUp" data-wow-delay="0.4s">
               <div style="padding:50px; background:#f9fafb; border-radius:12px; height:100%; display:flex; flex-direction:column; justify-content:center;">
                  <h3 style="color:#111827; font-family:'Rubik',sans-serif; font-size:28px; font-weight:600; margin-bottom:20px; letter-spacing:-0.5px;">Build for the Long Term</h3>
                  <p style="color:#6f7075; font-family:'Rubik',sans-serif; font-size:16px; line-height:1.7; margin:0;">Create systems that evolve instead of becoming another technical problem.</p>
               </div>
            </div>
         </div>
      </div>
...
{process_section}
   ...
   <section style="padding:120px 0; background:#f9fafb; text-align:center;">
      <div class="container">
         <span class="d-inline-block mb-3 wow fadeInUp" data-wow-delay="0.1s" style="color:var(--fv-red); font-family:'Rubik',sans-serif; font-size:13px; font-weight:700; letter-spacing:2px; text-transform:uppercase;">CASE STUDIES</span>
         <h2 class="wow fadeInUp" data-wow-delay="0.2s" style="font-family:'Rubik',sans-serif; font-size:46px; font-weight:600; letter-spacing:-1.5px; line-height:1.15; color:#111827; margin-bottom:30px;">We don't just talk about systems. We build them<span style="color:var(--fv-red);">.</span></h2>
            ...
            <div class="col-md-6 mb-4 wow fadeInUp" data-wow-delay="0.3s">
               <div style="background:#ffffff; border-radius:12px; overflow:hidden; box-shadow:0 10px 15px -3px rgba(0,0,0,0.1);">
                  ...
                  <div style="padding:30px;">
                     <h4 style="font-family:'Rubik',sans-serif; font-size:22px; font-weight:600; margin-bottom:15px; color:#111827;">E-Commerce Automation Ecosystem</h4>
                     <p style="color:#6f7075; font-family:'Rubik',sans-serif; font-size:16px; margin:0;">Reduced manual data entry by 100% and increased fulfillment speed by 3x.</p>
                  </div>
               </div>
            </div>
            <div class="col-md-6 mb-4 wow fadeInUp" data-wow-delay="0.4s">
               <div style="background:#ffffff; border-radius:12px; overflow:hidden; box-shadow:0 10px 15px -3px rgba(0,0,0,0.1);">
                  ...
                  <div style="padding:30px;">
                     <h4 style="font-family:'Rubik',sans-serif; font-size:22px; font-weight:600; margin-bottom:15px; color:#111827;">AI Customer Support Agent</h4>
                     <p style="color:#6f7075; font-family:'Rubik',sans-serif; font-size:16px; margin:0;">Automated 70% of inbound queries while maintaining a 98% CSAT score.</p>
                  </div>
               </div>
            </div>
         </div>
